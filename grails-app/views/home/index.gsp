...
<!-- MAIN CONTENT AREA: REDESIGN CUSTOM - HERO BLOCK 1 (TEXT BLOCK)] -->
                            <div class="span6 home-block hero-block-1">
                                <h1>歡迎您的光臨</h1>
                                <h2>為您的愛車提供最優質的服務</h2>
                                <p>開店已有 20 餘年，請相信我們的專業，誠摯為您服務，各種廠牌二手車量買賣與維修 bla bla</p>
                            </div>
...
<!-- MAIN CONTENT AREA: bizstrap CUSTOM - HERO BLOCK 2 -->
                            <div class="span5 home-block">
                                <div class="grey-box hero-block-2">
                                    <h2><a href="#">優惠消息！</a></h2>
                                    <p><g:img alt="logo" dir="images" file="release_icon.png" />
                                    		什麼東西正在優惠勒？
                                    </p>
              ...
              <hr>
                <div class="main-block block-posts">
                    <div class="title-wrapper">
                        <h2>最近的文章</h2><a href="#" class="all">Visit the full Post&nbsp;&raquo;</a>
                    </div>
...
%{--                                 <div class="span3">
                                    <a class="block-post-img" href="#">
                                        <img alt="" src="img/block_post_img1.jpg" class="img-rounded" />
                                    </a>
                                    <a class="block-post-title" href="#">Time Management for Designers</a>
                                    <p class="block-post-date">July 25, 2012</p>
                                    <p class="block-post-content">Ut non libero magna. Sed et quam lacus. Fusce condimentum eleifend enim a feugiat. Pellentesque viverra vehicula sem ut volutpat.</p>
                        ...
                        <div class="span12">
                            <div id="clients" class="row show-grid">
                                <div class="span2 clear-both hp-wrapper">
                                    <img alt="" src="img/client1.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="img/client2.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="img/client3.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="img/client4.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="img/client5.jpg" />
                                </div>
                                <div class="span2 hp-wrapper">
                                    <img alt="" src="img/client6.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
