databaseChangeLog = {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-1") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-2") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-3") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-4") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-5") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-6") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-7") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-8") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-9") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-10") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-11") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-12") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-13") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-14") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-15") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-16") {
		addPrimaryKey(columnNames: "role_id, user_id", constraintName: "user_rolePK", tableName: "user_role")
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-32") {
		createIndex(indexName: "name_uniq_1386750800889", tableName: "brand", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-33") {
		createIndex(indexName: "FK5C6729A7F6629BE", tableName: "event") {
			column(name: "store_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-34") {
		createIndex(indexName: "FK5C6729A94F1E5B6", tableName: "event") {
			column(name: "user_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-35") {
		createIndex(indexName: "FK5C6729ACDEEADFE", tableName: "event") {
			column(name: "product_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-36") {
		createIndex(indexName: "name_uniq_1386750800905", tableName: "event", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-37") {
		createIndex(indexName: "FK24C4619647AF3A18", tableName: "event_detail") {
			column(name: "head_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-38") {
		createIndex(indexName: "FK24C461966E7114B6", tableName: "event_detail") {
			column(name: "part_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-39") {
		createIndex(indexName: "name_uniq_1386750800917", tableName: "event_detail", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-40") {
		createIndex(indexName: "FK3463F310475694", tableName: "part") {
			column(name: "user_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-41") {
		createIndex(indexName: "FK3463F37F6629BE", tableName: "part") {
			column(name: "store_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-42") {
		createIndex(indexName: "name_uniq_1386750800921", tableName: "part", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-43") {
		createIndex(indexName: "FK3498A0CDEEADFE", tableName: "post") {
			column(name: "product_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-44") {
		createIndex(indexName: "name_uniq_1386750800926", tableName: "post", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-45") {
		createIndex(indexName: "FKED8DCCEF16985FFE", tableName: "product") {
			column(name: "brand_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-46") {
		createIndex(indexName: "FKED8DCCEF94F1E5B6", tableName: "product") {
			column(name: "user_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-47") {
		createIndex(indexName: "name_uniq_1386750800930", tableName: "product", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-48") {
		createIndex(indexName: "authority_uniq_1386750800933", tableName: "role", unique: "true") {
			column(name: "authority")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-49") {
		createIndex(indexName: "url_uniq_1386750800933", tableName: "security_map", unique: "true") {
			column(name: "url")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-50") {
		createIndex(indexName: "name_uniq_1386750800934", tableName: "store", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-51") {
		createIndex(indexName: "FK70D582A57F6629BE", tableName: "store_cost_detail") {
			column(name: "store_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-52") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-53") {
		createIndex(indexName: "FK7C35D6D45A3B441D", tableName: "tag_links") {
			column(name: "tag_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-54") {
		createIndex(indexName: "name_uniq_1386750800943", tableName: "tags", unique: "true") {
			column(name: "name")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-55") {
		createIndex(indexName: "FK36EBCB7F6629BE", tableName: "user") {
			column(name: "store_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-56") {
		createIndex(indexName: "username_uniq_1386750800947", tableName: "user", unique: "true") {
			column(name: "username")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-57") {
		createIndex(indexName: "FK143BF46A94F1E5B6", tableName: "user_role") {
			column(name: "user_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-58") {
		createIndex(indexName: "FK143BF46AEFC721D6", tableName: "user_role") {
			column(name: "role_id")
		}
	}

	changeSet(author: "Spooky (generated)", id: "1386750801022-17") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-18") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-19") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-20") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-21") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-22") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-23") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-24") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-25") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-26") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-27") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-28") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-29") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-30") {
	...
	changeSet(author: "Spooky (generated)", id: "1386750801022-31") {
